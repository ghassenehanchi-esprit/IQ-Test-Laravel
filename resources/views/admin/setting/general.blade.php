                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group ">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" type="number" name="show_number_after_decimal" required value="{{ $general->show_number_after_decimal }}">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group ">
                                    <label>@lang('Winner Bonus')</label>
                                    <input class="form-control" type="number" step="any" name="winner_bonus" required value="{{ $general->winner_bonus }}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group ">
