                ...
                <div class="menu-area">
                    <ul class="menu">
                        ...
                        @guest
                            <li class="d-lg-none d-block">
                                <div class="d-flex flex-wrap justify-content-lg-between">
                                    <a href="{{ route('user.login') }}" class="btn btn--base-outline btn-sm me-2">@lang('Login')</a>
                        ...
                        @else
                            <li class="d-lg-none d-block">
                                <div class="d-flex flex-wrap justify-content-lg-between">
                                    <a href="{{ route('user.home') }}" class="btn btn--base btn-sm me-2">@lang('Dashboard')</a>
                    ...
                    @guest
                        <div class="header-buttons d-lg-block d-none ml-auto">
                            <a href="{{ route('user.login') }}" class="btn btn--base-outline btn-md me-2">@lang('Login')</a>
                            <a href="{{ route('user.register') }}" class="btn btn--base btn-md ">@lang('Register')</a>
                        </div>
                    @else
                        <div class="header-buttons d-lg-block d-none ml-auto">
                            <a href="{{ route('user.home') }}" class="btn btn--base btn-md me-2">@lang('Dashboard')</a>
                            <a href="{{ route('user.logout') }}" class="btn btn--base-outline btn-md">@lang('Logout')</a>
                        </div>
                    @endguest
