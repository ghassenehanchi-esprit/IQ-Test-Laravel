...
@endphp
<section class="faq-section padding-bottom section-bg">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 d-lg-block d-none rtl">
                <img src="{{getImage('assets/images/frontend/faq/'.@$content->data_values->faq_image,'682x592')}}" class="img-fluid">
            </div>
