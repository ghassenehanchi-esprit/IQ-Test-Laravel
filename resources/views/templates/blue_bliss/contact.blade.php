            ...
            <div class="col-xl-5 col-lg-6 ps-lg-5">
                <div class="contact-item">
                    ...
                    <div class="contact-item__content">
                        ...
                        <a class="contact-item__desc" href="mailto:{{@$content->data_values->email }}">{{ @$content->data_values->email }}</a>
                    </div>
                </div>
                <div class="contact-item">
                    ...
                    <div class="contact-item__content">
                        ...
                        <a class="contact-item__desc"  href="tel:{{@$content->data_values->mobile }}">{{ @$content->data_values->mobile }}</a>
                    </div>
                </div>
                <div class="contact-item">
