        ...
        <div class="row gy-4">
            ...
            <div class="col-md-12">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control form--control bg-white referralURL" value="{{ route('home') }}?reference={{ $user->username }}" readonly>
                    <button type="button" class="input-group-text text--base bg-white" id="copyBoard"><i class="la la-copy"></i></button>
                </div>
            </div>
