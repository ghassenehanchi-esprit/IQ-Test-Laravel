class FormGenerator{
    constructor(formClassName = null) {
        this.fieldType = null;
        this.totalField = 0;
        this.appendTo = ".addedField";
        this.inputName = "form_generator";
            ...
            html = `
                <div class="form-group">
                    ...
                    <div class="input-group w-auto flex-fill">
                        <input type="text" name="options[]" class="datepicker-here form-control bg--white pe-2" data-position="bottom right" placeholder="Select Date" autocomplete="off">
                        <button class="btn btn--primary input-group-text"><i class="la la-calendar"></i></button>
                    </div>
                </div>
    ...
    html = `
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" name="options[]" >
                </div>
            `;
}
else {
        ...
        return `
            <div class="form-group">
                <div class="input-group">
                    ...
                    <button class="btn btn--danger input-group-text removeOption" type="button"><i class="las la-times"></i></button>
                </div>
            </div>
        `;
    }
    ...
    makeFormHtml(formItem,updateId){
        ...
        var hiddenFields = `
            <input type="hidden" name="${this.inputName}[is_required][]" value="${formItem.is_required}">
            <input type="hidden" name="${this.inputName}[extensions][]" value="${formItem.extensions}">
            <input type="hidden" name="${this.inputName}[options][]" value="${formItem.options}">
        `;
        var formsHtml = `
            ${hiddenFields}
            <div class="card-body">
                <div class="form-group">
                    <label>Label</label>
                    <input type="text" name="${this.inputName}[form_label][]" class="form-control" value="${formItem.label}" readonly>
                </div>
                <div class="form-group">
                    <label>
                    ...
                    <input type="text" name="${this.inputName}[form_type][]" class="form-control" value="${formItem.type}" readonly>
                </div>
