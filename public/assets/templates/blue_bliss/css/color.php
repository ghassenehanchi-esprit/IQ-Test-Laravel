...
?>
.scrollToTop,
input[type="submit"], .custom-pagination li a.active, .common-pagination span, ::selection, .header-bottom .header-bottom-area .menu-area .menu li .sub-menu li:hover > a, .header-bar span, .exchange-form .form-group input[type="submit"], .exchange-form .form-group .rates, .section-bg.get-service .exchange-form .form-group input[type="submit"],.blog-sidebar .widget.widget-search form .form-group button, .feature-item::after, .how-item.active .serial, .how-item:hover .serial, .newsletter-form button, .get-service .exchange-form .form-group input[type="submit"], .account-form .form-group input[type="submit"], .privacy-content .item .bullet-list li::before, .contact-form .form-group input[type="submit"], .contact--item::before, .contact--item::after, .process-tab .tab-menu li.active , .exchange-from-to-form .form-group input[type="submit"], .theme-button, .post-item .post-content::before, .post-item .post-content::after, .post-item.post-details .post-content .thumb-area ul li::before, .post-item blockquote::before, .blog-pagination li a.active, .blog-pagination li a:hover, .comment-wrapper li .comment-item:hover .reply-button , .comment-form-group button, .custom-button, .custom-button.white:hover, .swiper-slide-next .custom-button:hover, .swiper-slide-next .custom-button.white , .transaction-table .t-header, .widget.widget-search .search--form button, .widget.widget-tags ul li a:hover, .bg_theme, .list::-webkit-scrollbar-track,.copied::after,.btn--base,.bg--base,.form--check .form-check-input:checked,.form--control[type="file"]::-webkit-file-upload-button,.widget-item__icon,.custom--table thead,.page-item.active .page-link,.page-link:focus,.pagination .page-item .page-link.active, .pagination .page-item .page-link:hover,.btn--base-outline:hover,.contact-item__icon,
